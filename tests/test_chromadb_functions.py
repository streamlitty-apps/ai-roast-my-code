...
from app.chromadb_utils.chromadb_helpers import run_query, retrieve_data, serialize_retrieved_data
...
class TestChromaDBFunctions(unittest.TestCase):
    ...
    def test_run_query(self, mock_client):
        ...
        mock_collection.query.assert_called_with(query_texts=["test query"], n_results=2)
    ...
    async def test_ingest_data(self, mock_client, mock_open, mock_glob):
        ...
        mock_client.return_value.create_collection.assert_called_with(name=collection_name)
